...
completion_models:
  {defs.DEFAULT_COMPLETION_MODEL_ID}:
    ...
    api_key: <DEFAULT_COMPLETION_API_KEY> # set this in the generated .env file, or remove if managed identity
    retry:
...
completion_models:
  {defs.DEFAULT_COMPLETION_MODEL_ID}:
    model_provider: <DEFAULT_MODEL_PROVIDER>
    model: <DEFAULT_COMPLETION_MODEL>
    auth_method: ${{NA}} # or azure_managed_identity
    api_key: <DEFAULT_COMPLETION_API_KEY> # set this in the generated .env file, or remove if managed identity
...
GRAPHRAG_API_KEY=<API_KEY>
NA=NA
GRAPHRAG_CHAT_API_BASE=http://localhost:8080/v1
GRAPHRAG_EMBEDDING_API_BASE=http://localhost:8080/v1
CLICKHOUSE_HOST=127.0.0.1
CLICKHOUSE_PORT=9001
CLICKHOUSE_PROTOCOL=native
CLICKHOUSE_TABLE_DB=graphrag_tables
CLICKHOUSE_VECTOR_DB=graphrag_vectors
CLICKHOUSE_USER=clickhouse
CLICKHOUSE_PASSWORD=clickhouse
CLICKHOUSE_TABLE_NAMESPACE=graphrag
"""

# Backward compatibility for callers that still import the old constant names.
INIT_YAML_INHOUSE = INIT_YAML_OSS
INIT_DOTENV_INHOUSE = INIT_DOTENV_OSS
